...
plot 'data/read_16_diffreg' with linespoints, \
'data/read_16_samereg' with linespoints, \
'data/read_32_diffreg' with linespoints, \
'data/read_32_samereg' with linespoints, \
'data/read_4_samereg' with linespoints, \
'data/read_64_diffreg' with linespoints, \
